  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="relative">
        ...
        {/* Main Content Card */}
        <Card className="w-full max-w-7xl p-8 md:p-12 bg-white/80 backdrop-blur-xl shadow-2xl border-t border-white/50">
          <div className="text-center">
            ...
            <div className="max-w-2xl mx-auto mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-6 leading-tight">
                Redefine Hiring with Verifind
              </h2>
              <p className="text-lg text-gray-600">
                Discover talent based on proven skills, not just resumes.
              </p>
            </div>
